    ...
    render() {
        return (
            <article className="pay-view">
                <DBheader title="支付" left={'goBack'}/>
                <header className="pay-header">
                    <div className="total-title">商品合计 <span className="total-num">300许愿币</span></div>
                    <div className="total-goods">商品数量 <span className="total-good-num">10件</span><span className="right-btn">&#xe604;</span></div>
                ...
                <section className="pay-money">
                    ...
                    <div className="balance">
                        ...
                        <div className="balance-right"><span>-100夺宝币</span><span className="charge-box box">&#xe600;</span>
                        </div>
                    </div>
                </section>
